...
data1=figure(title="Production Chart of Selected Country From 1971 to 2015",x_axis_label=(data_pilihan['Year'], data_pilihan['Production'])
data1.line(x,y,legend_label='Trend',line_width=4)
